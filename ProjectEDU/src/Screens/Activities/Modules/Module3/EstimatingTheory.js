...
import {  View,StyleSheet,Button,Dimensions,Image,Text,Alert} from 'react-native';
        ...
        <View style = {{ alignItems:"center",marginTop:-60}}>
            <Header
                ...
                rightComponent={{ 
                    icon: 'arrow-forward', 
                    color: '#fff',
                    onPress: () => this.props.navigation.navigate("PCM_EstimatingActivity1")
                    }}
            />
        </View>
...
const styles = StyleSheet.create({
  ...
  export default createSwitchNavigator(
    {
      PCM_EstimatingTypes:     PCM_EstimatingTypesScreen,
      PCM_EstimatingInputs:    PCM_EstimatingInputsScreen,
      PCM_EstimatingTools:     PCM_EstimatingToolsScreen,
      PCM_EstimatingOutputs:   PCM_EstimatingOutputsScreen
