      ...
      <View style={styles.container}>
        ...
        <View style = {{alignItems:"center",marginTop:40}}>
          ...
          <TouchableHighlight style={[styles.buttonContainer, styles.activitiesButton]} 
            onPress={() => this.props.navigation.navigate("PCM_EstimatingInputs")}>
...
<View style={styles.container}>
      ...
      <View style={{
        ...
        <View style = {{alignItems:"center",marginTop:40}}>
          ...
          <TouchableHighlight style={[styles.buttonContainer, styles.activitiesButton]} 
            onPress={() => this.props.navigation.navigate("PCM_EstimatingTools")}>
              <Text style={styles.buttonText}>Continue studying</Text>
          </TouchableHighlight>
    ...
    <View style={{
      ...
      <View style={{
        ...
        <View style = {{alignItems:"center",marginTop:40}}>
          ...
          <TouchableHighlight style={[styles.buttonContainer, styles.activitiesButton]} 
            onPress={() => this.props.navigation.navigate("PCM_EstimatingOutputs")}>
              <Text style={styles.buttonText}>Continue studying</Text>
          </TouchableHighlight>
    ...
    <View style={{
      ...
      <View style={{
        ...
        <View style = {{alignItems:"center",marginTop:40}}>
          ...
          <TouchableHighlight style={[styles.buttonContainer, styles.activitiesButton]} 
            onPress={() => this.props.navigation.navigate("EstimatingActivities")}>
